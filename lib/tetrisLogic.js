...
function lockTetromino(board, tetromino, position) {
  ...
  export function calculateShadowPosition(gameState) {
    ...
    // Simulate moving the tetromino down until it collides
  ...
  //SHOW NEXY BLOCC SAME WAY THE HOLD SHOWS THE BLOCC IMAGE
  // THE NEXT BLOCC SECTION SHOWS THE NEXT INCOMING FIVE BLOCCS
  // REPRESENTED BY IMAGES TOO
  // IT WILL BE TO THE RIGHT OF THE GRID WHERE BLOCCS FALL

  //CLEARED LINE COUNTER BELOW SCORE
